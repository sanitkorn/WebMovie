					...
					<div role="tabpanel" class="tab-pane fade active in" id="home" aria-labelledby="home-tab">
						<div class="w3_agile_featured_movies">
							<div class="col-md-2 w3l-movie-gride-agile">
								<a href="{{asset('single.html" class="hvr-shutter-out-horizontal')}}"><img src="{{asset('images/s-l301.jpg')}}" title="album-name" class="img-responsive" alt=" " />
									<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
								</a>
								<div class="mid-1 agileits_w3layouts_mid_1_home">
									<div class="w3l-movie-text">
										<h6><a href="{{asset('single.html')}}">Hello Word I</a></h6>							
									</div>
							...
							<div class="col-md-2 w3l-movie-gride-agile">
								<a href="{{asset('single.html')}}" class="hvr-shutter-out-horizontal"><img src="{{asset('images/image1.jpg')}}" title="album-name" class="img-responsive" alt=" "  />
									<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
								</a>
								<div class="mid-1 agileits_w3layouts_mid_1_home">
									<div class="w3l-movie-text">
										<h6><a href="{{asset('single.html')}}">Road T9 Ninja</a></h6>							
									</div>
									<div class="mid-2 agile_mid_2_home">
										<p>2019</p>
										<div class="block-stars">
							...
							<div class="col-md-2 w3l-movie-gride-agile">
								<a href="{{asset('single.html')}}" class="hvr-shutter-out-horizontal"><img src="{{asset('images/am1.jpg')}}" title="album-name" class="img-responsive" alt=" " />
									<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
								</a>
								<div class="mid-1 agileits_w3layouts_mid_1_home">
									<div class="w3l-movie-text">
							...
							<div class="col-md-2 w3l-movie-gride-agile">
								<a href="{{asset('single.html')}}" class="hvr-shutter-out-horizontal"><img src="{{asset('images/27826312.jpg')}}" title="album-name" class="img-responsive" alt=" " />
									<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
								</a>
								<div class="mid-1 agileits_w3layouts_mid_1_home">
									<div class="w3l-movie-text">
										<h6><a href="{{asset('single.html')}}">i want to eat your pancreas</a></h6>							
									</div>
									<div class="mid-2 agile_mid_2_home">
										<p>2019</p>
										<div class="block-stars">
							...
							<div class="col-md-2 w3l-movie-gride-agile">
								...
								<div class="mid-1 agileits_w3layouts_mid_1_home">
									<div class="w3l-movie-text">
										<h6><a href="{{asset('single.html')}}">Hello word II</a></h6>							
									</div>
									<div class="mid-2 agile_mid_2_home">
										<p>2019</p>
										<div class="block-stars">
							...
							<div class="col-md-2 w3l-movie-gride-agile">
								<a href="{{asset('single.html')}}" class="hvr-shutter-out-horizontal"><img src="{{asset('images/slient.jpg')}}" title="album-name" class="img-responsive" alt=" " />
									<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
								</a>
								<div class="mid-1 agileits_w3layouts_mid_1_home">
									<div class="w3l-movie-text">
										<h6><a href="{{asset('single.html')}}">War Dogs</a></h6>							
									</div>
									<div class="mid-2 agile_mid_2_home">
										<p>2019</p>
										<div class="block-stars">
							...
							<div class="col-md-2 w3l-movie-gride-agile">
								<a href="{{asset('single.html')}}" class="hvr-shutter-out-horizontal"><img src="{{asset('images/images (2).jfif')}}" title="album-name" class="img-responsive" alt=" "  />
									<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
								</a>
								<div class="mid-1 agileits_w3layouts_mid_1_home">
									<div class="w3l-movie-text">
							...
							<div class="col-md-2 w3l-movie-gride-agile">
								<a href="{{asset('single.html')}}" class="hvr-shutter-out-horizontal"><img src="{{asset('images/voice.jpg')}}" title="album-name" class="img-responsive" alt=" " />
									<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
								</a>
								<div class="mid-1 agileits_w3layouts_mid_1_home">
									<div class="w3l-movie-text">
										<h6><a href="{{asset('single.html')}}">Civil War</a></h6>							
									</div>
									<div class="mid-2 agile_mid_2_home">
										<p>2019</p>
										<div class="block-stars">
