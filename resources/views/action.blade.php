...
<!-- //nav -->
<div class="general">
		<h4 class="latest-text w3_latest_text">Action</h4>
		<div class="container">
					...
					<div role="tabpanel" class="tab-pane fade active in" id="home" aria-labelledby="home-tab">
						<div class="w3_agile_featured_movies">
							<div class="col-md-2 w3l-movie-gride-agile">
								<a href="{{asset('single.html" class="hvr-shutter-out-horizontal')}}"><img src="{{asset('images/m15.jpg')}}" title="album-name" class="img-responsive" alt=" " />
									<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
								</a>
								<div class="mid-1 agileits_w3layouts_mid_1_home">
									<div class="w3l-movie-text">
										<h6><a href="{{asset('single.html')}}">God’s Compass</a></h6>							
									</div>
							...
							<div class="col-md-2 w3l-movie-gride-agile">
								<a href="{{asset('single.html')}}" class="hvr-shutter-out-horizontal"><img src="{{asset('images/savage.jpg')}}" title="album-name" class="img-responsive" alt=" "  />
									<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
								</a>
								<div class="mid-1 agileits_w3layouts_mid_1_home">
									<div class="w3l-movie-text">
										<h6><a href="{{asset('single.html')}}">Savage</a></h6>							
									</div>
									<div class="mid-2 agile_mid_2_home">
										<p>2019</p>
										<div class="block-stars">
							...
							<div class="col-md-2 w3l-movie-gride-agile">
								<a href="{{asset('single.html')}}" class="hvr-shutter-out-horizontal"><img src="{{asset('images/m5.jpg')}}" title="album-name" class="img-responsive" alt=" " />
									<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
								</a>
								<div class="mid-1 agileits_w3layouts_mid_1_home">
									<div class="w3l-movie-text">
							...
							<div class="col-md-2 w3l-movie-gride-agile">
								<a href="{{asset('single.html')}}" class="hvr-shutter-out-horizontal"><img src="{{asset('images/m16.jpg')}}" title="album-name" class="img-responsive" alt=" " />
									<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
								</a>
								<div class="mid-1 agileits_w3layouts_mid_1_home">
									<div class="w3l-movie-text">
										<h6><a href="{{asset('single.html')}}">Rezort</a></h6>							
									</div>
									<div class="mid-2 agile_mid_2_home">
										<p>2019</p>
										<div class="block-stars">
							...
							<div class="col-md-2 w3l-movie-gride-agile">
								<a href="{{asset('single.html')}}" class="hvr-shutter-out-horizontal"><img src="{{asset('images/m1.jpg')}}" title="album-name" class="img-responsive" alt=" " />
									<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
								</a>
								<div class="mid-1 agileits_w3layouts_mid_1_home">
									<div class="w3l-movie-text">
							...
							<div class="col-md-2 w3l-movie-gride-agile">
								...
								<div class="mid-1 agileits_w3layouts_mid_1_home">
									<div class="w3l-movie-text">
										<h6><a href="{{asset('single.html')}}">Bad Mom</a></h6>							
									</div>
									<div class="mid-2 agile_mid_2_home">
										<p>2019</p>
										<div class="block-stars">
							...
							<div class="col-md-2 w3l-movie-gride-agile">
								<a href="{{asset('single.html')}}" class="hvr-shutter-out-horizontal"><img src="{{asset('images/m19.jpg')}}" title="album-name" class="img-responsive" alt=" " />
									<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
								</a>
								<div class="mid-1 agileits_w3layouts_mid_1_home">
									<div class="w3l-movie-text">
							...
							<div class="col-md-2 w3l-movie-gride-agile">
								...
								<div class="mid-1 agileits_w3layouts_mid_1_home">
									<div class="w3l-movie-text">
										<h6><a href="{{asset('single.html')}}">X-man</a></h6>							
									</div>
									<div class="mid-2 agile_mid_2_home">
										<p>2019</p>
										<div class="block-stars">
